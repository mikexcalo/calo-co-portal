...
export interface FrameworkModule {
  ...
  asks: string[];
  /**
   * The raw material this module cannot be written without.
   *
   * Inputs, not wording. How you get somebody to hand these over is judgement
   * and voice and reading the room, and a template written in somebody else's
   * register is worse than no template. This is only the checklist: have you
   * got these yet, or not.
   */
  needs: string[];
}
...
export const FRAMEWORK: FrameworkModule[] = [
  {
    ...
    needs: [
      ...
      "What people did before it existed, and why that was bad",
      "Why the founders started it",
      "Something they believe that others in their category do not",
    ],
  },
  {
    id: "brand_promise",
    ...
    needs: [
      "What a customer gets that they could hold you to",
      "What letting that customer down would look like",
      "Whether the product can actually control that outcome",
    ],
  },
  {
    id: "north_star",
    ...
    needs: [
      "Where the business is going in three years, stated as a condition rather than a revenue number",
      "What would have to be true for that to happen",
      "The one word the team already uses when something feels right",
    ],
  },
  {
    id: "audience",
    ...
    needs: [
      "Buyer title, company size, and what their day actually looks like",
      "Who is explicitly not the buyer",
      "What they are using today instead",
      "The trigger that makes them start looking",
      "Who else is in the room when it gets approved",
    ],
  },
  {
    id: "positioning",
    ...
    needs: [
      "The category in the buyer's own words, not an invented one",
      "The alternative this displaces",
      "Why that alternative fails people",
    ],
  },
  {
    id: "tone",
    ...
    needs: [
      "Two or three things they have written that sound like them, ideally customer emails",
      "Something in their category that made them cringe",
      "Words and phrases they use that nobody else in the category uses",
    ],
  },
  {
    id: "pitch",
    ...
    needs: [
      "Their own one sentence version, unpolished",
      "Their thirty second version",
      "The follow up question they get asked most often after saying it",
    ],
  },
  {
    id: "pillars",
    ...
    needs: [
      "The two or three things they say on every sales call without fail",
      "Which of those a competitor could not say",
    ],
  },
  {
    id: "proof",
    ...
    needs: [
      "Customers who would go on record, with name, title and company",
      "Numbers with a stated source and a date",
      "Logos with written permission on file",
      "Results they want and do not have yet, recorded as gaps",
    ],
  },
  {
    id: "guardrails",
    ...
    needs: [
      "Words and phrases that are banned, each with its reason",
      "Internal shorthand that must never reach a customer",
      "Anything published that was regretted afterwards",
    ],
  },
];
