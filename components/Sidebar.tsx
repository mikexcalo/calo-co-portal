...
const icons: Record<string, React.ReactNode> = {
  ...
  brandKit: <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4.5" width="7" height="8.5" rx="1"/><rect x="5" y="3" width="7" height="10" rx="1" fill="var(--page-bg, #111113)"/><rect x="8" y="1.5" width="6" height="11.5" rx="1" fill="var(--page-bg, #111113)"/></svg>,
  designStudio: <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"><path d="M8 2C4.7 2 2 4.7 2 8s2.7 6 6 6c.6 0 1-.4 1-1v-.3c0-.4.3-.7.7-.7h1.3c1.7 0 3-1.3 3-3 0-3.9-2.7-7-6-7Z"/><circle cx="5" cy="7" r="0.9" fill="currentColor" stroke="none"/><circle cx="8" cy="5" r="0.9" fill="currentColor" stroke="none"/><circle cx="11" cy="7" r="0.9" fill="currentColor" stroke="none"/></svg>,
